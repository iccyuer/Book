...
import com.example.book.books.entity.JsonBean;
import com.example.book.books.utils.GetJsonDataUtil;
...
//                        Toast.makeText(RegisterActivity.this, "开始解析数据", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(RegisterActivity.this, "解析数据成功", Toast.LENGTH_SHORT).show();
                    isLoaded = true;
                    if (isLoaded) {
                        ShowPickerView();
                    }
    ...
    private void ShowPickerView() {// 弹出选择器
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(mContext, new OptionsPickerView.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                mOnConfirmListener.onConfirm(tx);
