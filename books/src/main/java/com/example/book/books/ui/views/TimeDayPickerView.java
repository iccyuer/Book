...
public class TimeDayPickerView {
    private TimePickerView pvTime;
    private Context mContext;

    public TimeDayPickerView(Context context) {
        mContext = context;
        initTimePicker();
    }
...
//                .setDecorView(null)
    ...
    private TimeYearPickerView.onPickerConfirm mOnPickerConfirm;

    public void setOnPickerConfirm(TimeYearPickerView.onPickerConfirm onPickerConfirm) {
